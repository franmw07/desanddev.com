...
export const skills = {
  ...
  habilidades: [
    { es: "Facilidad para el trabajo en equipo", en: "Teamwork skills" },
    { es: "Adaptación al cambio", en: "Adaptability" },
    { es: "En constante aprendizaje", en: "Continuous learner" },
    { es: "Lenguajes: Español e Ingles", en: "Languages: Spanish and English" },
